<?php
	...
	if(isset($_POST['edit'])){
		...
		try{
			...
			$sql = $db->prepare("UPDATE subject SET subject_code = :subject_code, course_id = :course_id, course_description = :course_description, total_units = :total_units, with_lab_component = :with_lab_component WHERE id = :id ");
